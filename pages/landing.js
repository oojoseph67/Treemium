                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-xl-7 col-md-6">
                                <div class="intro-content">
                                    ...
                                    <div class="mt-4">
                                        <Link href="javascript:void(0)"  class="btn my-1 waves-effect">
                                    ...
                                    <div class="card-body">
                                        <div class="buy-sell-widget px-2">
                                            <form method="post" name="myform" class="currency_validate">
                                                ...
                                                <a href="javascript:void(0)" class="btn btn-success w-100">Exchange
                                                    Now </a>
                                                ...
                                                <table class="table mb-0 table-responsive-sm">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><Link href="javascript:void(0)"  class="btn btn-success">Buy</Link></td>
                                                        </tr>
                                                        <tr>
                                                            <td><span>2</span>
                                                            </td>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="features-content">
                                    ...
                                    <Link href="javascript:void(0)" >Learn more <i class="la la-angle-right"></i></Link>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="features-content">
                        ...
                        <div class="row portfolio_list">
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <h4>Mobile apps</h4>
                                        <p>Stay on top of the markets with the Treemium app for <Link href="javascript:void(0)" >Android</Link> or
                                            <Link href="javascript:void(0)" >iOS</Link>.
                                        </p>
                                    </div>
                                </div>
                            </div>
